        ...
        <tbody>
            ...
            <?php foreach ($brands as $row): ?>
                ...
                <?php endif; ?>
                    ...
                    <td>
                        <a href="/laptofy_MVC/viewbrand/<?= (int)$row['brand_id'] ?>">
                        <button>View</button>
                        </a>
                    </td>
                    <td>
                        <a href="/laptofy_MVC/editbrand/<?= (int)$row['brand_id'] ?>">
                        <button>Edit</button>
                        </a>
                    </td>
                    <td>
                        <a href="/laptofy_MVC/deletebrand/<?= (int)$row['brand_id'] ?>"
    ...
    <tfoot>
        ...
        <tr>
            <td colspan="5" align="center">
                <a href="/laptofy_MVC/addbrand">
                <button>Add New Brand</button>
                </a>

                <a href="/laptofy_MVC/productlist">
